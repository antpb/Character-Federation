	...
	async fetch(request, env, ctx) {
		try {
			...
			switch (path) {
				...
				case 'federation/sync-characters':
					if (!await authenticateRequest(request, env)) {
						return new Response('Unauthorized', { status: 401 });
					}
					return federation.fetch(new Request('http://federation/sync-characters', {
						method: 'POST',
						body: request.body,
						headers: request.headers
					}));
...
function getAdminHTML() {
    ...
    <html lang="en">
    <head>
      <title>Character Federation Management</title>
      <meta charset="UTF-8">
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
          <div class="bg-gray-900 rounded-lg shadow-xl p-8">
            <h1 class="text-2xl font-bold mb-6 text-center">Character Federation Manager</h1>
            ...
            <div id="mainPanel" class="hidden">
              <div class="mb-8 flex items-center justify-between bg-gray-800 p-4 rounded">
                ...
                <form id="addSourceForm" class="mb-8 p-4 bg-gray-800 rounded">
                  <h3 class="text-lg font-medium mb-4">Add Character Source</h3>
                  <div class="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        name="instance_url"
                        required
                        placeholder="https://characters.your-domain.com"
              ...
              return \`
                <div class="bg-gray-800 p-4 rounded">
                  <div class="flex items-center">
                    ...
                    <span class="ml-2">
                      Character <strong>\${activity.character_name}</strong> updated from 
            ...
            <tr class="border-t border-gray-700">
              ...
              <td class="px-4 py-2">
                <div>
                  ...
                  <div class="text-xs text-gray-400">
                    \${source.character_count || 0} characters • \${source.subscriber_count || 0} subscribers
                  </div>
                </div>
              </td>
              <td class="px-4 py-2">
